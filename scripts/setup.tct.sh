...
SCRIPT_VERSION="2.0"
MAIN_TITLE="TechCare Trauma Gateway Deployment Configuration Tool v$SCRIPT_VERSION"
GLOBAL_PRODUCT="tct"

# Default values
VERSION_NAME="latest"
INTEGRATOR_URL="https://tctus.predict.milvue.com"
...
function save_config(){
    ...
    echo "INF_COMM=$INF_COMM" >> $config_file
